...
public class CursedPong extends MainMenuScreen {
	...
	public void render () {
		...
		batch.draw(Models.score,70f,Const.screenHeight-40f,120,34); //First Player Score
		batch.draw(Models.score,Const.screenWidth-150f,Const.screenHeight-40f,120,34); //Second player score
